...
- **Android Chrome / desktop Chrome/Edge**: use the *Install* prompt in the address bar / menu.

The service worker (via `vite-plugin-pwa`) precaches the bundle so it launches
